...
class RB_Race: NSObject {
    ...
    convenience init(generalDescription: String?, traits: String?) {
        self.init()
...
"""
    override init() {
        super.init()
        races = [Android, Aquarian, Avion, Dwarves, Elves, Half_Elves, Half_Folk, Humans, Rakashans, Saurians]
    }
    var races: [RB_Race] = []
    var Android: RB_Race = RB_Race(generalDescription: """
    ...
    var Aquarian: RB_Race = RB_Race(generalDescription: "From the crushing ocean depths come aquatic folk. They are thick and sturdy beneath the waves but often vulnerable in the dry air or searing heat of the surface.", traits: """
    ...
    var Avion: RB_Race = RB_Race(generalDescription: "Avions are humanoids with wings. They tend to be very slight of build owing to their hollow bones. Some are feathered while others are leathery or even scaled.", traits: """
    ...
    var Dwarves: RB_Race = RB_Race(generalDescription: """
...
""")
    ...
    var Humans: RB_Race = RB_Race(generalDescription: """
    ...
    var Rakashans: RB_Race = RB_Race(generalDescription: """
    ...
    var Saurians: RB_Race = RB_Race(generalDescription: "Lizard men typically come from steaming jungles or deep deserts where they have unique civilizations unknown to other sentient races.", traits: """
